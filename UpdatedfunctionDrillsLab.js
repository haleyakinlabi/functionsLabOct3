...
let movieResult = bestMovie('Lord of the Rings')
...
let evalResult = arrayEvaluator(bigOrSmallArray)
...
//CODE HERE
function theEliminator(arr, loserStr){
  for(let i = 0; i < arr.length; i++){
    let kid = arr[i]
      if (kid === loser){
        arr.splice([i], 1)
...
let newContest = theEliminator(contestants)
...
function upperCase(str){
  let strAnswer = str.toUpperCase()
  console.log(strAnswer)
}
upperCase("Hi, my name is Kylo.")
